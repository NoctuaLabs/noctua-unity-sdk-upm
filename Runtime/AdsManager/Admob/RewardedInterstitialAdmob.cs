...
namespace com.noctuagames.sdk.Admob
{
    ...
    public class RewardedInterstitialAdmob
    {
        ...
        public void SetRewardedInterstitialAdUnitID(string adUnitID)
        {
            if (adUnitID == null)
            {
                _log.Warning("Ad unit ID Rewarded Interstitial is empty.");
                return;
            }
        ...
        public void LoadRewardedInterstitialAd()
        {
            ...
            {
                _log.Warning("Ad unit ID Rewarded Interstitial is not configured.");
                return;
            }
                ...
                (RewardedInterstitialAd ad, LoadAdError error) =>
                {
                    ...
                    if (error != null || ad == null)
                    {
                        ...
                        EmitCanonical(IAAEventNames.AdLoadFailed, IAAPayloadBuilder.BuildAdLoadFailed(
                            adFormat:   AdFormatKey.RewardedInterstitial,
                    ...
                    TrackAdCustomEventRewardedInterstitial("wf_ri_request_adunit_success");
                    TrackAdCustomEventRewardedInterstitial("wf_ri_request_finished_success");
        ...
        public void ShowRewardedInterstitialAd()
        {
            ...
            else
            {
                ...
                _log.Warning("Rewarded Interstitial ad is not ready to be shown.");
            }
        }
        ...
        private void RegisterEventHandlers(RewardedInterstitialAd ad)
        {
            ...
            ad.OnAdPaid += (AdValue adValue) =>
            {
                ...
                UniTask.Void(async () =>
                {
                    ...
                    {
                        _log.Error($"Error tracking AdMob rewarded-interstitial revenue: {ex.Message}\n{ex.StackTrace}");
                    }
                });
        ...
        private void EmitCanonical(string eventName, Dictionary<string, IConvertible> payload)
        {
            ...
            {
                _log.Error($"Error emitting canonical RI event '{eventName}': {ex.Message}\n{ex.StackTrace}");
            }
        }
    }
}
